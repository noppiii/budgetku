package com.budgetku.backend.payload.request.invoice;
...
public class MovementRequest extends AbstractRequest {
    ...
    @Schema(description = "Calculated IVA (VAT) value for the movement, based on the IVA rate and value.", example = "210", nullable = true)
    private Double ivaValue;

    @Schema(description = "Total value of the movement, including IVA (VAT).",
            example = "1210", nullable = true)
    ...
    private MovementStatus status = MovementStatus.ACCEPTED;
    ...
    private BudgetSubtypeResponse budgetSubtype;
